...
export SST_BUILD_GEM5_SST_3_0_0=1
#===============================================================================
# GEM5
#===============================================================================
#-------------------------------------------------------------------------------
...
#     None
#-------------------------------------------------------------------------------
export SST_DEPS_GEM5_VERSION_LOCAL="SST 3.0.0"
export SST_DEPS_SRC_STAGED_GEM5=${SST_DEPS_SRC_STAGING}/sst-gem5-devel.devel
sstDepsStage_gem5 ()
{
    sstDepsAnnounce -h $FUNCNAME -m "Staging sstgem5 3.0.0"
    ...
    do
        ...
        then
            ...
            then
                ...
                echo "ERROR: sstDep_gem5_SST-3.0.0.sh: sstmacro hg repository clone failure."
...
sstDepsDeploy_gem5 ()
{
    sstDepsAnnounce -h $FUNCNAME -m "Deploying sstgem5 SST-3.0.0"
    ...
    then
        # bail out on error
        echo "ERROR: sstDep_gem5_SST-3.0.0.sh: gem5 scons failure"
        return $retval
    else
    ...
    # installed
    sstDepsAnnounce -h $FUNCNAME -m "Installing sstgem5 SST-3.0.0"
...
sstDepsQuery_gem5 ()
{
    ...
    echo "export SST_DEPS_VERSION_GEM5SST=\"SST-3.0.0\""
