...
export SST_BUILD_GEM5_SST_2_3_1=1
#===============================================================================
# GEM5
#===============================================================================
#-------------------------------------------------------------------------------
...
#     None
#-------------------------------------------------------------------------------
export SST_DEPS_GEM5_VERSION_LOCAL="SST 2.3.1"
export SST_DEPS_SRC_STAGED_GEM5=${SST_DEPS_SRC_STAGING}/sst-gem5-devel.devel
sstDepsStage_gem5 ()
{
    sstDepsAnnounce -h $FUNCNAME -m "Staging sstgem5 2.3.1"
    ...
    do
        ...
        then
            ...
            then
                ...
                echo "ERROR: sstDep_gem5_SST-2.3.1.sh: sstmacro hg repository clone failure."
            ...
            # select 2.3.1 tag on 2.3.1_pre branch
            echo "Selecting gem5 2.3.1 tag on 2.3.1_pre development branch."
            hg update 2.3.1
...
sstDepsDeploy_gem5 ()
{
    sstDepsAnnounce -h $FUNCNAME -m "Deploying sstgem5 SST-2.3.1"
    ...
    then
        ...
        scons -j8 build/X86_SE/libgem5_opt.dylib --verbose < $TMPDIR/yes.in
    else
    ...
    then
        # bail out on error
        echo "ERROR: sstDep_gem5_SST-2.3.1.sh: gem5 scons failure"
        return $retval
    else
    ...
    # installed
    sstDepsAnnounce -h $FUNCNAME -m "Installing sstgem5 SST-2.3.1"
