...
export SST_BUILD_MACSIM_2_2_0=1
#===============================================================================
# Macsim
#===============================================================================
#-------------------------------------------------------------------------------
...
sstDepsStage_macsim ()
{
    tarFile="macsim-2.2.0.tar.gz"
#   knownSha1=e1b88b9bf18053a24783d9062e66e4c91fc7691a
    knownSha1=53933c0d73b22b78e25b8c8ad34ef1d76e9951b7
    ...
    then
        ...
        wget https://github.com/macsimgt/macsim-public/releases/download/v2.2.0/$tarFile --no-check-certificate
        retval=$?
        popd
        if [ $retval -ne 0 ]
        then
...
sstDepsQuery_macsim ()
{
    ...
    echo "export SST_DEPS_VERSION_MACSIM=\"2.2.0\""
