# !/bin/bash
# sstDep_gem5_mixed_ompi_1.7.2_gcc_4.6.4.sh
...
sstDepsStage_gem5 ()
{
    sstDepsAnnounce -h $FUNCNAME -m "Staging sstgem5 Mixed gcc-4_6_4"
    ...
    do
        ...
        then
            ...
            then
                ...
                echo "ERROR: sstDep_gem5_mixed_ompi_1.7.2_gcc_4.6.4.sh: sstmacro hg repository clone failure."
...
sstDepsDeploy_gem5 ()
{
    sstDepsAnnounce -h $FUNCNAME -m "Deploying sstgem5 Mixed GCC-4.6.4 OMPI-1.7.2"
    ...
    #    Appearently when we get here, "module" is no longer defined
    # start .profile
    ...
    module rm boost
    module rm gcc mpi 
    module add gcc/gcc-4.6.4 mpi/openmpi-1.7.2_gcc-4.6.4
    module list  
    ...
    then
        # bail out on error
        echo "ERROR: sstDep_gem5_mixed_ompi_1.7.2_gcc_4.6.4.sh: gem5 scons failure"
        return $retval
    else
    ...
    # installed
    sstDepsAnnounce -h $FUNCNAME -m "Installing sstgem5 Mixed gcc-4_6_4"
