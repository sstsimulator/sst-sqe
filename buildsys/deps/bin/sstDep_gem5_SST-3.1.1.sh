    ...
    do
        ...
        then
            ...
            then
                ...
                echo "ERROR: sstDep_gem5_SST-3.1.1.sh: sstmacro hg repository clone failure."
...
sstDepsDeploy_gem5 ()
{
    sstDepsAnnounce -h $FUNCNAME -m "Deploying sstgem5 SST-3.1.1"
    ...
    then
        # bail out on error
        echo "ERROR: sstDep_gem5_SST-3.1.1.sh: gem5 scons failure"
        return $retval
    else
