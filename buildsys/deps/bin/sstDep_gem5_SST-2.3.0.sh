...
export SST_BUILD_GEM5_SST_2_3_0=1
#===============================================================================
# GEM5
#===============================================================================
#-------------------------------------------------------------------------------
...
#     None
#-------------------------------------------------------------------------------
export SST_DEPS_GEM5_VERSION_LOCAL="SST 2.3.0"
export SST_DEPS_SRC_STAGED_GEM5=${SST_DEPS_SRC_STAGING}/sst-gem5-devel.devel
sstDepsStage_gem5 ()
{
    sstDepsAnnounce -h $FUNCNAME -m "Staging sstgem5 2.3.0"
    ...
    do
        ...
        then
            ...
            then
                ...
                echo "ERROR: sstDep_gem5_SST-2.3.0.sh: sstmacro hg repository clone failure."
            ...
            # select 2.3 tagged revision
            echo "Selecting gem5 SST-2.3.0 tagged revision."
            hg update 2.3.0
...
sstDepsDeploy_gem5 ()
{
    sstDepsAnnounce -h $FUNCNAME -m "Deploying sstgem5 SST-2.3.0"
    ...
    then
        # bail out on error
        echo "ERROR: sstDep_gem5_SST-2.3.0.sh: gem5 scons failure"
        return $retval
    else
    ...
    # installed
    sstDepsAnnounce -h $FUNCNAME -m "Installing sstgem5 SST-2.3.0"
