...
export SST_BUILD_MACSIM_2_0_3=1
#===============================================================================
# Macsim
#===============================================================================
#-------------------------------------------------------------------------------
...
sstDepsStage_macsim ()
{
    tarFile="macsim-2.0.3.tar.gz"
    knownSha1=ffc2180d11fa8cba7a24423dfa6aa1805573ff52
    ...
    then
        ...
        echo "ERROR: (${FUNCNAME})  Can't read ${SST_DEPS_SRC_PRISTINE}/${tarFile}. Try a down load "

        pushd ${SST_DEPS_SRC_PRISTINE}
        
        wget https://github.com/macsimgt/macsim-public/releases/download/2.0.3/macsim-2.0.3.tar.gz --no-check-certificate
        retval=$?
        popd
        if [ $retval -ne 0 ]
        then
...
sstDepsQuery_macsim ()
{
    ...
    echo "export SST_DEPS_VERSION_MACSIM=\"2.0.3_PRE\""
