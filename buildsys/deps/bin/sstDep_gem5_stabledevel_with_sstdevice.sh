# !/bin/bash
# sstDep_gem5_stabledevel_wth_sstdevice.sh
...
export SST_BUILD_GEM5_STABLEDEVEL_WITH_SSTDEVICE=1
#===============================================================================
# GEM5
#===============================================================================
#-------------------------------------------------------------------------------
...
#     None
#-------------------------------------------------------------------------------
export SST_DEPS_GEM5_VERSION_LOCAL="stabledevel_with_sstdevice"
export SST_DEPS_SRC_STAGED_GEM5=${SST_DEPS_SRC_STAGING}/sst-gem5-devel.devel
sstDepsStage_gem5 ()
{
    sstDepsAnnounce -h $FUNCNAME -m "Staging sstgem5 stabledevel (with SSTDEVICE enabled)"
    ...
    do
        ...
        then
            ...
            hg clone https://code.google.com/p/sst-gem5-devel.devel/ sst-gem5-devel.devel
        fi
        ...
        then
            ...
            then
                ...
                echo "ERROR: sstDep_gem5_stabledevel_wth_sstdevice.sh: sstmacro hg repository clone failure."
...
sstDepsDeploy_gem5 ()
{
    sstDepsAnnounce -h $FUNCNAME -m "Deploying sstgem5 stabledevel (with SSTDEVICE enabled)"
    ...
    then
        ...
        scons sstdevice=1 build/X86_SE/libgem5_opt.dylib --verbose < $TMPDIR/yes.in
    else
    ...
    then
        # bail out on error
        echo "ERROR: sstDep_gem5_stabledevel_wth_sstdevice.sh: gem5 scons failure"
        return $retval
    else
    ...
    # installed
    sstDepsAnnounce -h $FUNCNAME -m "Installing sstgem5 stabledevel  (with SSTDEVICE enabled)"
