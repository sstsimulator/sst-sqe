...
#    fi
    ...
    case $1 in
        sstmainline_config) 
            ...
            depsStr="-r none -H default -G default -k none -d 2.2.2 -p none -g none -m none -i none -o none -h none -s none -q 0.2.1 -M none -N default -z 3.83 -c default"
        ...
        sstmainline_config_all) 
            ...
            coreMiscEnv="${cc_environment} ${mpi_environment}"
            elementsMiscEnv="${cc_environment}"
            depsStr="-r none -H default -G default -k none -d 2.2.2 -p none -g none -m none -i none -o none -h none -s none -q 0.2.1 -M 2.2.0 -N default -z 3.83 -c default"
            setConvenienceVars "$depsStr"
            coreConfigStr="$corebaseoptions --with-zoltan=$SST_DEPS_INSTALL_ZOLTAN $coreMiscEnv"
        ...
        sstmainline_config_stream|sstmainline_config_openmp|sstmainline_config_diropenmp|sstmainline_config_diropenmpB|sstmainline_config_diropenmpI|sstmainline_config_dirnoncacheable|sstmainline_config_dir3cache|sstmainline_config_memH_Ariel) 
            ...
            coreMiscEnv="${cc_environment} ${mpi_environment}"
            elementsMiscEnv="${cc_environment}"
            depsStr="-r none -H default -G default -k none -d 2.2.2 -p none -z none -g none -m none -i none -o none -h none -s none -M none -N default"
            setConvenienceVars "$depsStr"
        ...
        sstmainline_config_linux_with_ariel_no_gem5) 
            ...
            coreMiscEnv="${cc_environment} ${mpi_environment}"
            elementsMiscEnv="${cc_environment}"
            depsStr="-r none -H default -G default -k none -d 2.2.2 -p none -z 3.83 -g none -m none -i none -o none -h none -s none -q 0.2.1 -M none -N default"
            setConvenienceVars "$depsStr"
            coreConfigStr="$corebaseoptions --with-zoltan=$SST_DEPS_INSTALL_ZOLTAN $coreMiscEnv"
        ...
        sstmainline_config_no_mpi)
            ...
            elementsMiscEnv="${cc_environment}"
            depsStr="-r none -H default -G default -k none -d 2.2.2 -p none -z none -g none -m none -i none -o none -h none -s none -q none  -M none -N default"
            setConvenienceVars "$depsStr"
        ...
        sstmainline_config_static) 
            ...
            coreMiscEnv="${cc_environment} ${mpi_environment}"
            elementsMiscEnv="${cc_environment}"
            depsStr="-r none -H default -G default -k none -d 2.2.2 -p none -g stabledevel -m none -i none -o none -h none -s none -q 0.2.1 -M 2.2.0 -N default -z 3.83"
            setConvenienceVars "$depsStr"
        ...
        sstmainline_config_static_no_gem5) 
            ...
            coreMiscEnv="${cc_environment} ${mpi_environment}"
            elementsMiscEnv="${cc_environment}"
            depsStr="-r none -H default -G default -k none -d 2.2.2 -p none -z none -g none -m none -i none -o none -h none -s none -q 0.2.1 -M 2.2.0 -N default -z 3.83"
            setConvenienceVars "$depsStr"
            coreConfigStr="$corebaseoptions --enable-static --disable-shared --with-zoltan=$SST_DEPS_INSTALL_ZOLTAN $coreMiscEnv"
        ...
        sstmainline_config_clang_core_only) 
            ...
            elementsConfigStr="$elementsbaseoptions --with-hbmdramsim=$SST_DEPS_INSTALL_HBM_DRAMSIM2 --with-goblin-hmcsim=$SST_DEPS_INSTALL_GOBLIN_HMCSIM --with-dramsim=$SST_DEPS_INSTALL_DRAMSIM --with-nvdimmsim=$SST_DEPS_INSTALL_NVDIMMSIM --with-hybridsim=$SST_DEPS_INSTALL_HYBRIDSIM"
            macroConfigStr="NOBUILD"
            externalelementConfigStr="$externalelementbaseoptions"
            junoConfigStr="$junobaseoptions"
            ;;
        sstmainline_config_macosx) 
            ...
            coreMiscEnv="${cc_environment} ${mpi_environment}"
            elementsMiscEnv="${cc_environment}"
            depsStr="-r none -H default -G default -k none -d 2.2.2 -p none -g stabledevel -m none -i none -o none -h none -s none -q none -z 3.83 -N default -M 2.2.0"
            setConvenienceVars "$depsStr"
            coreConfigStr="$corebaseoptions --with-zoltan=$SST_DEPS_INSTALL_ZOLTAN $coreMiscEnv"
        ...
        sstmainline_config_macosx_no_gem5) 
            ...
            coreMiscEnv="${cc_environment} ${mpi_environment}"
            elementsMiscEnv="${cc_environment}"
            depsStr="-r none -H default -G default -k none -d 2.2.2 -p none -z 3.83  -g none -m none -i none -o none -h none -s none -q none -M none -N default -c default"
            setConvenienceVars "$depsStr"
        ...
        sstmainline_config_test_output_config)
            ...
            coreMiscEnv="${cc_environment} ${mpi_environment}"
            elementsMiscEnv="${cc_environment}"
            depsStr="-r none -H default -G default -k none -d 2.2.2 -p none -g stabledevel -m none -i none -o none -h none -s none -q 0.2.1 -M none -N default -z 3.83"
            setConvenienceVars "$depsStr"
        ...
        sstmainline_config_memH_wo_openMP)
            ...
            coreMiscEnv="${cc_environment} ${mpi_environment}"
            elementsMiscEnv="${cc_environment}"
            depsStr="-r none -H default -G default -k none -d 2.2.2 -p none -z none -m none -o none -h none -s none -q none -M none -N default"
            setConvenienceVars "$depsStr"
            coreConfigStr="$corebaseoptions $coreMiscEnv"
        ...
        sst-macro_withsstcore_mac) 
            ...
            depsStr="-r none -H default -G default -k none -d none -p none -g none -m none -i none -o none -h none -s none -q none -M none -N one -z none -c none"
            setConvenienceVars "$depsStr"
