# !/bin/bash
# testSuite_sstexternalelement.sh
...
#===============================================================================
L_SUITENAME="SST_sstexternalelement_suite" # Name of this test suite; will be used to
...
#-------------------------------------------------------------------------------
# Test:
#     test_sstexternalelement
# Purpose:
#     Exercise the SimpleExternalElement of the sst-external-element
# Inputs:
#     None
# Outputs:
#     test_sstexternalelement.out file
# Expected Results
...
sstexternalelement_Template() {
    ...
    sutArgs="${SST_ROOT}/sst-external-element/tests/${test_name}.py"
