...
link_n0bus_n0l3cache.connect( (comp_n0_bus, "low_network_0", "100ps"), (comp_n0_l3cache, "high_network_0", "100ps") )
link_n0bus_memory = sst.Link("link_n0bus_memory")
link_n0bus_memory.connect( (comp_n0_l3cache, "directory", "100ps"), (comp_chipRtr, "port2", "1000ps") )
link_n1bus_n1l3cache = sst.Link("link_n1bus_n1l3cache")
link_n1bus_n1l3cache.connect( (comp_n1_bus, "low_network_0", "100ps"), (comp_n1_l3cache, "high_network_0", "100ps") )
link_n1bus_memory = sst.Link("link_n1bus_memory")
link_n1bus_memory.connect( (comp_n1_l3cache, "directory", "100ps"), (comp_chipRtr, "port3", "1000ps") )
